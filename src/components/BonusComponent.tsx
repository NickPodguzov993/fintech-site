...
const BonusComponent = (props:BonusComponentType) => {
    ...
    return (
        <div className='relative'>
            <div onClick={()=>{setShow(!show)}} className=" px-6 py-4  bg-white rounded-[20px] border border-rose-600 justify-center items-center gap-4 inline-flex ml-2 mb-2 ">
                <div className="text-rose-600 text-xl font-bold font-['Raleway'] leading-[30px]">{props.num}</div>
                <div className="text-rose-600 text-xl font-medium font-['Raleway'] leading-[30px]">{props.title}</div>
            </div>
            {show && <div className="grow shrink basis-0 flex-col justify-start items-start gap-8 inline-flex absolute ">
                <div className="self-stretch bg-neutral-100 rounded-[40px] justify-center items-start inline-flex">
                    ...
                    <div className="grow shrink basis-0 p-8 flex-col justify-start items-center gap-4 inline-flex">
                        <div className="self-stretch text-zinc-900 text-xl font-bold font-['Raleway']">{props.title}</div>
