        ...
        <div className='hidden sm:flex'>
            <div className="w-[1400px] h-[901px] flex-col justify-start items-center gap-20 inline-flex">
                <div className="self-stretch justify-center items-center gap-16 inline-flex">
                    ...
                    <div className="grow shrink basis-0 h-[120px] rounded-[40px] justify-center items-center gap-2.5 flex">
                        <div className="grow shrink basis-0 text-zinc-900 text-xl font-medium font-['Raleway'] leading-[30px]">Благодаря накопленной экспертизе и профессионализму, мы оказываем высокий уровень качества сопровождения и обеспечиваем оптимизацию операционных затрат start-up it-проектов</div>
                    </div>
                </div>
                <div className="self-stretch h-[650px] flex-col justify-start items-center gap-4 flex">
                    <div className="self-stretch justify-center items-start gap-4 inline-flex">
                        ...
                        <div className="grow shrink basis-0 h-[480px] flex-col justify-start items-center gap-px inline-flex">
                            <div className="self-stretch grow shrink basis-0 p-8 bg-neutral-100 rounded-[40px] flex-col justify-start items-start gap-4 flex">
                                <div className="self-stretch text-zinc-900 text-[32px] font-medium font-['Raleway'] leading-[48px]">Проактивность</div>
                                <div className="self-stretch text-zinc-900 text-base font-bold font-['Raleway'] leading-relaxed">Мы способны и готовы действовать, предлагать, пробовать, опережая современные  тенденции (реалии).</div>
                            </div>
                            <div className="self-stretch grow shrink basis-0 p-8 bg-neutral-100 rounded-[40px] flex-col justify-start items-start gap-4 flex">
                                <div className="self-stretch text-zinc-900 text-[32px] font-medium font-['Raleway'] leading-[48px]">Поощрение инициатив</div>
                                <div className="self-stretch justify-start items-start gap-4 inline-flex">
                                    <div className="grow shrink basis-0 text-zinc-900 text-base font-bold font-['Raleway'] leading-relaxed">Мы стимулируем живой интерес, увлеченность и идейность наших сотрудниковю.</div>
                                </div>
                            </div>
                        </div>
