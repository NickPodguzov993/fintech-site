...
const BonusDescription = ({config,theme}:BonusDescriptionType) => {
    return (
            <div className="grow shrink basis-0 flex-col justify-start items-start gap-8 inline-flex w-[300px]  sm:w-[668px] top-[170px]  absolute">
                <div className="self-stretch rounded-[40px] justify-center items-start inline-flex"  style={{backgroundColor: theme === 'light' ? '#F5F5F5' : '#212121'}}>
                    <img className="grow shrink basis-0 self-stretch p-4 rounded-[40px] w-[334px] h-[auto] " src={config.img}/>
